...
public interface IEngineer
{
    ...
    /// <exception cref="BlDoesNotExistException">Thrown when there is no Engineer with this ID in the DAL</exception>
    ...
    /// <exception cref="BlAlreadyExistsException"> thrown when the identifier already exists in the DL</exception>
    /// <exception cref="BlInvalidInputException"> thrown when engineer information is invalid or missing</exception>
    ...
    /// <exception cref="BlDoesNotExistsException"> thrown when when the identifier is not found in the DL</exception>
    /// <exception cref="BlCannotBeDeletedException"> thrown when the engineer appears as assigned or completed one of the tasks at the very least</exception>
